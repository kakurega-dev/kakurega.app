...
<div class="_gaps">
	...
	<MkInput v-else-if="v.type === 'followersLessThanOrEq' || v.type === 'followersMoreThanOrEq' || v.type === 'followingLessThanOrEq' || v.type === 'followingMoreThanOrEq' || v.type === 'patreonAmountsMoreThanOrEq' || v.type === 'patreonAmountsLessThanOrEq' || v.type === 'notesLessThanOrEq' || v.type === 'notesMoreThanOrEq'" v-model="v.value" type="number">
	</MkInput>
...
const typeDef = [
	...
	{ label: i18n.ts._role._condition.patreonAmountsLessThanOrEq, value: 'patreonAmountsLessThanOrEq' },
	{ label: i18n.ts._role._condition.patreonAmountsMoreThanOrEq, value: 'patreonAmountsMoreThanOrEq' },
...
const typeModelForMkSelect = computed<GetMkSelectValueTypesFromDef<typeof typeDef>>({
	...
	set: (t) => {
		...
		switch (t) {
			...
			case 'patreonAmountsLessThanOrEq': newValue = { type: 'patreonAmountsLessThanOrEq', value: 500 }; break;
			case 'patreonAmountsMoreThanOrEq': newValue = { type: 'patreonAmountsMoreThanOrEq', value: 500 }; break;
