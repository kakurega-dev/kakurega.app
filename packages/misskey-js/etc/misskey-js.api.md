...
// @public (undocumented)
export const queueTypes: readonly ["system", "endedPollNotification", "scheduledNoteDelete", "postScheduledNote", "deliver", "inbox", "db", "relationship", "objectStorage", "userWebhookDeliver", "systemWebhookDeliver"];
